...
> Add notes here: long term observations are necessary for monitoring and better understanding certain ecological processes or changes.
...
(NTL.phys.data.1999$year4)

# Exercise 2: 
# filter NTL.phys.data for Tuesday Lake from 1990 through 1999.

NTL.phys.data.Tuesday.Lake <- filter(NTL.phys.data, lakename %in% c("Tuesday Lake"))
NTL.phys.data.Tuesday.Lake.90.to.99 <-filter(NTL.phys.data.Tuesday.Lake, year4 %in% c(1990:1999))
```
