...
NTL.phys.data.Tuesday.90.to.99 <- filter(NTL.phys.data.Tuesday, year4 >= 1990 & year4 <= 1999)
NTL.phys.data.Tuesday.90.to.99
```
Question: Why don't we filter using row numbers?

> Answer: Rows are arbitrary!
...
#East Long Lake, sampled on July 7, 1998 at a depth of 0.5 meters
```
### Select
